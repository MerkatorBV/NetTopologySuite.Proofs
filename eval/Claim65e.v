(* ============================================================================
   nts-eval micro unit — claimId 65-e (GREEN)
   Red planted 2026-08-02 (20bd629, as 65-c) · Green closed 2026-08-02
   (renumbered 65-e: the 65-c id was taken concurrently by the aborted
   envelope claim, and 65-d by the miter clip)
   ----------------------------------------------------------------------------
...
(* -------------------------------------------------------------------------- *)
(* The 65-e claim (stated; closed below).                                  *)
