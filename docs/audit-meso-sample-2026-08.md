...
| # | Item | Notes / flags |
|---|---|---|
| B1 | PA-footer backfill: `PassesThrough_b64_grid_exact.v` (0/79) first, then `InCircle_b64_exact.v` (8/77), `HotPixel_b64.v` (45/97), and the 8 other `theories-flocq/` files with no footers | **DONE 2026-08-15** — every flocq Theorem/Lemma/Corollary/Proposition/Fact now has a matching `Print Assumptions` (967/967). Header tags (`topic:` / `claimId:` / `witness:`) on the six B1 priority files. See `docs/corpus-meta.md`. |
