...
`/wayfinder 522 leftovers` refreshes the leftovers chart. Leftover `Ⅰ` is the T-junction / partial-edge kiss ([`map-tjunction-cert.md`](../map-tjunction-cert.md)). Leftover `ⅠⅠ` is
the obtuse-at-v certificate ([`map-obtuse-cert.md`](../map-obtuse-cert.md)). Sibling #523 alphabet grill:
...
is the gate for ticket 11 precondition 3. Leftover `ⅠⅠ` is named
([`map-obtuse-cert.md`](../map-obtuse-cert.md)); `/implement` of `ⅠⅠ` is a
later letter. Do not mint leftover `ⅠⅠⅠ`.
