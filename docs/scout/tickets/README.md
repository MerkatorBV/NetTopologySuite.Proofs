...
**Related living maps.** MULTISURFACE type honesty (TRIAGE CRV-MS):
[`docs/scout/map-multisurface.md`](../map-multisurface.md). Ticket
[35](closed/35-multisurface-type-chart.md) closed as the chart.
Ticket [36](36-multisurface-silent-multipolygon-collapse.md) names
the silent-MULTIPOLYGON leftover. HOLD implement stands. Do not
steal COMPOUNDCURVE ticket 30 (PR #656), CURVEPOLYGON ticket 32
(PR #657), or MULTICURVE ticket 34 (PR #658). Do not remint `#509`.
Off JTS #7.
