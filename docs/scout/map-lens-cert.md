...
(fill still `UNSUPPORTED`). Leftover `Ⅷ` classifies the inside pair
A = `(1,1)(2,1)(1,2)`, B = `(0,0)(4,0)(0,4)`. Decline golden is the
unnamed same-side shared-edge pair A = `(0,0)(4,0)(0,4)`,
B = `(0,0)(4,0)(1,1)`.
