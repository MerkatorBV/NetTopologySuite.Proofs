...
| — | COMPOUNDCURVE flatten-elimination | CRV-CC / ticket 30 | technique | Sibling letter. Lineal compound chord Flatten. Lives on PR #656. | steal ticket 30 for a CURVEPOLYGON site |
...
(`cursor/compoundcurve-wayfinder-ccfa`). Numbered 31 / 32 so merge
does not collide.
