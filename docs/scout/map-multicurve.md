...
| — | COMPOUNDCURVE flatten-elimination | CRV-CC / ticket 30 | technique | Sibling. Single contiguous compound. Lives on PR #656. | steal ticket 30 for a MultiCurve site |
| — | CURVEPOLYGON silent POLYGON collapse | CRV-CP / ticket 32 | technique | Sibling. Surface type. Lives on PR #657. | steal ticket 32 |
...
Numbered 33 / 34 so merge does not collide.
