...
the container `_CoqProject.full` builds the entire corpus (589
registered modules — 499 registered under `theories/`, 90 registered under `theories-flocq/`).
...
- This is **not** complete. Current coverage is over 6,300 Qed-closed
  theorems across 589 registered modules — 499 registered under `theories/`,
