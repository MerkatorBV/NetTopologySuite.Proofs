...
the container `_CoqProject.full` builds the entire corpus (519
registered modules — 431 in `theories/`, 88 in `theories-flocq/`).
...
- This is **not** complete. Current coverage is over 5,100 Qed-closed
  theorems across 519 registered `.v` modules (431 under `theories/` —
