...
the container `_CoqProject.full` builds the entire corpus (492
registered modules — 413 in `theories/`, 79 in `theories-flocq/`).
...
- This is **not** complete. Current coverage is over 5,100 Qed-closed
  theorems across 492 registered `.v` modules (413 under `theories/` —
