...
the container `_CoqProject.full` builds the entire corpus (510
registered modules — 425 in `theories/`, 85 in `theories-flocq/`).
...
- This is **not** complete. Current coverage is over 5,100 Qed-closed
  theorems across 510 registered `.v` modules (425 under `theories/` —
