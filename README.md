...
The ceiling has named exceptions rather than silent ones: 32 files under
...
Stdlib-only layer. The full corpus is 592 registered modules —
502 registered under `theories/` and 90 registered under
