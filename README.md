...
the container `_CoqProject.full` builds the entire corpus (507
registered modules — 422 in `theories/`, 85 in `theories-flocq/`).
...
- This is **not** complete. Current coverage is over 5,100 Qed-closed
  theorems across 507 registered `.v` modules (422 under `theories/` —
