...
The ceiling has named exceptions rather than silent ones: 25 files under
...
Stdlib-only layer. The full corpus is 585 registered modules —
495 registered under `theories/` and 90 registered under
