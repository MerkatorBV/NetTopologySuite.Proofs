...
The ceiling has named exceptions rather than silent ones: 29 files under
...
Stdlib-only layer. The full corpus is 589 registered modules —
499 registered under `theories/` and 90 registered under
