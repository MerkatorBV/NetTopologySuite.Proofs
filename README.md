...
the container `_CoqProject.full` builds the entire corpus (503
registered modules — 418 in `theories/`, 85 in `theories-flocq/`).
...
- This is **not** complete. Current coverage is over 5,100 Qed-closed
  theorems across 503 registered `.v` modules (418 under `theories/` —
