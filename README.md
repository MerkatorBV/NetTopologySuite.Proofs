...
the container `_CoqProject.full` builds the entire corpus (508
registered modules — 423 in `theories/`, 85 in `theories-flocq/`).
...
- This is **not** complete. Current coverage is over 5,100 Qed-closed
  theorems across 508 registered `.v` modules (423 under `theories/` —
