...
the container `_CoqProject.full` builds the entire corpus (493
registered modules — 414 in `theories/`, 79 in `theories-flocq/`).
...
- This is **not** complete. Current coverage is over 5,100 Qed-closed
  theorems across 493 registered `.v` modules (414 under `theories/` —
