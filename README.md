...
the container `_CoqProject.full` builds the entire corpus (509
registered modules — 424 in `theories/`, 85 in `theories-flocq/`).
...
- This is **not** complete. Current coverage is over 5,100 Qed-closed
  theorems across 509 registered `.v` modules (424 under `theories/` —
