...
the container `_CoqProject.full` builds the entire corpus (491
registered modules — 412 in `theories/`, 79 in `theories-flocq/`).
...
- This is **not** complete. Current coverage is over 5,100 Qed-closed
  theorems across 491 registered `.v` modules (412 under `theories/` —
