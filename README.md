...
the container `_CoqProject.full` builds the entire corpus (490
registered modules — 411 in `theories/`, 79 in `theories-flocq/`).
...
- This is **not** complete. Current coverage is over 5,100 Qed-closed
  theorems across 490 registered `.v` modules (411 under `theories/` —
  41 of them in the host `_CoqProject` foundational target — plus 79
