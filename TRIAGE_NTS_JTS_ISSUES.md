...
| **TRI-DT** | Delaunay on (densified) curved boundaries | #68 | `theories-flocq/InCircle_b64_exact.v` (primitive), `DelaunayEmptyCircle.v`, `DelaunayFlipWitness.v`, `DelaunayFlipGeometric.v`, `DelaunayEdgeEmptyCircle.v` (68-a), `Triangle.v`, `Tin.v` | 🟡 in-circle primitive ✅ + empty-circle predicate ✅ + flip sign algebra ✅ + **edge ↔ empty-circle (weak skeleton) ✅**; geometric insert / full covering DT + curved densification planned |
