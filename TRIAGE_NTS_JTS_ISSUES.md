...
| **#615** | ISO 13249-3 conformance for the curve foundation branch (fork `feat/curves-structure-wkt-foundation`; not proof work — differential + clause conformance, oracle-pinned) | `Expectant` | **A+B scope landed 2026-08-30; C (validity lane) opened and continues past the epic by design.** Captures (`615-a`, #616): ADR-0005 lenient-intake/strict-IsValid + CONTEXT.md *Curve conformance* glossary (`88e61e8` + `ce12455`). Fork landings: nested-CC flatten `2c4c7bc` (`615-b`, #617); empty-component intake drop `4c787c2`+`2d84afd` (`615-c`, #619); exact Length `2ccd353`+`df5ba57` (`615-d`, #618); exact Envelope `9111983`+`88e4af6` (`615-e`, #620); exact point-to-curve Distance `b829d42`+`61f4981` (`615-f`, #622); IsValid rung 1 `359b334`+`505ffaa` (`615-g`, #623); IsSimple rung 1 `b392590`+`e00c00b` (`615-h`, #624 — closed) rung 2 `8ffd90a`+`5372346` (#630 — multi-segment CS via the pairwise contact kernel; residues: degenerate segments, nearly-cocircular band, large-circumradius conditioning guard) rung 3 `66265ed`+`53cca68` (#634 — CompoundCurve/CurvePolygon-ring chains, IsValid verdicts: clean CS/CC checked-valid, non-simple CP ring definite-false; canonical `TryCircle`; differential `ok=61`) and rung 4 `217f032`+`8429bd9` (#639 — MultiCurve/MultiSurface simplicity + validity, CP Desc-11 counting, MS 1-D boundary overlap definite-false, non-finite fail-close; the rung-3 silent-true GC-arm hole closed; review fold: tangency refusal band + residue deferral, retro-covering the rungs-2/3 tangent verdicts; differential `ok=69` with the new `HOLES_DISJOINT` section); WKT/WKB small print `ed40bf3`+`5fa469a` (`615-i`, #621). One-SoT: `docs/iso13249-3-curve-type-bindings-2026-08.md` (`SUMMARY ok`; §5b wrap-up gates: fork Curves+IO 441 green modulo the 4 pre-existing GML2 `WriteEmpty*`; illustrator 53/53, 0 skipped; oracle differential `ok=55 warn=0 bug_or_fail=0`; gauntlet `ok=5`). | Keep open until owner sign-off — wrap-up is #625 / `615-j`; the validity lane's next rung is #641 (CP Desc 12–14 + hole containment, MS interiors-disjoint, exact-arithmetic upgrades) |
