...
| **#69** | Umbrella / epic tracker | `Expectant` | Tracking issue only. Latest 2026-06-21: ARC_BUFFER_SIMPLE (oracle + Coq), #64 D-PT discharges (2/3), #67 S15l + JCT/Jordan. **PR #534:** `JordanRingKit.v` clique facade (PIP + overlay + Jordan seam; `claimId: none`). | Keep open as the epic tracker |
