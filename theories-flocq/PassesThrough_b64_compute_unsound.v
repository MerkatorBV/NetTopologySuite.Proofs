...
Print Assumptions compute_true.
Print Assumptions Bfin_val.
Print Assumptions norm54.
Print Assumptions bpow2_2.
Print Assumptions bpow2_3.
Print Assumptions bpow2_0.
Print Assumptions C54_pos.
Print Assumptions C54_neq.
Print Assumptions val_P0x.
Print Assumptions val_P0y.
Print Assumptions val_P1x.
Print Assumptions val_P1y.
Print Assumptions val_Cx.
Print Assumptions val_Cy.
Print Assumptions half_val.
Print Assumptions cancelC.
Print Assumptions three_term.
Print Assumptions plusminus_term.
Print Assumptions two_term.
Print Assumptions frac_lt.
Print Assumptions xa_val.
Print Assumptions xb_val.
Print Assumptions ya_val.
Print Assumptions yb_val.
Print Assumptions x1_ne_x0.
Print Assumptions y1_ne_y0.
Print Assumptions key_lt.
Print Assumptions touch_orig_false.
