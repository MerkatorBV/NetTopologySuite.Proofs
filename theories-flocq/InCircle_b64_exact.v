(* ============================================================================
   ...
   SPLIT (2026-08-19): the Flocq-free Z/R kernel (Zfold_min8, IZR packs,
   degree-4 det algebra, `2^k` magnitude bounds) lives in
   InCircle_b64_exact_refs.v and is deliberately off
   docs/audit-exceptions.txt.  This file keeps the binary64-facing
   sign / integer-regime / Perron tracks and Require Export's the
   kernel, so reverse dependencies import unchanged.
...
(* `Zfold_min8` and the IZR / det-algebra lemmas live in                        *)
(* InCircle_b64_exact_refs.v.                                                   *)
(* -------------------------------------------------------------------------- *)
...
(* Magnitude lemmas live in InCircle_b64_exact_refs.v.                        *)
(* -------------------------------------------------------------------------- *)
