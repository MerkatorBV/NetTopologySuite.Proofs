...
(* Payload B2R / Bcompare facts.  Finite B2R is ± IZR m * bpow e.
   Bcompare itself is computational; do not rewrite Bcompare_correct
   (that lemma and Rcompare are the C2 leak). *)
