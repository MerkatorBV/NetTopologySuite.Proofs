(* ============================================================================
   ...
   ----------------------------------------------------------------------------
   Leftover Ⅸ nest pair plus the unnamed swapped-nest completeness
   cex after leftover Ⅸ (not leftover `Ⅹ`). Split out of
   RelateNGUnnamedCex.v so that file stays under the 1234-line
   split gate. UnnamedCex re-exports this module.

   Nest pair: A = (0,0)(4,0)(0,4), B = (0,0)(4,0)(1,1). Shared
   edge, same-side thirds; B's third vertex strictly inside A.
   Classifies TPR_Nest.

   Live cex: A = (0,0)(4,0)(1,1), B = (0,0)(4,0)(0,4). The swap —
   `nest_b` is B-in-A only. Do not mint leftover `Ⅹ`. Do not steal
   522-j / 522-m.
...
(* -------------------------------------------------------------------------- *)
(* Unnamed swapped-nest completeness cex after leftover Ⅸ.                   *)
(* Not leftover `Ⅹ`. A = (0,0)(4,0)(1,1), B = (0,0)(4,0)(0,4).               *)
(* -------------------------------------------------------------------------- *)
