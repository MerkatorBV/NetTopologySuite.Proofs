(* ==========================================================================
   ...
   Sibling modules (restored on-manifest split of the former monofile):
     - `C3eEfCorridorAssumption.v`  (§C-3e-A: ef-vs-corridor thresholds)
     - `HandoffConnector.v`         (§C-3e-B: handoff chord + algebraic bypass)
     - `BaseToTipHeadline.v`        (§C-3e-C: along-dart headline + discharge)
