(* ============================================================================
   ...
   There is no TPR_Lens ⇒ interiors meet.

   Compiled pair A = (0,0)(3,0)(0,3), B = (2,-1)(2,2)(-1,2). Both
   CCW. (1,1) is strictly in both interiors. No shared vertex.
   `overlap_b` is still a vertex-stab certificate and misses. A's
   hypotenuse x+y=3 crosses B's vertical x=2 at (2,1). That is
   the missing overlap_b clause; this letter parks it on TPR_Lens
   instead of widening the certificate. Fill stays `im_unsupported`
   ...
   swap nest after leftover `Ⅸ`. Relocating
   ...
   `overlap_b`. Do not mint 522-n / leftover `Ⅹ`. Do not remint
   leftover `Ⅷ` / leftover `Ⅸ`. Do not remint leftover `Ⅵ`.
...
(* Epic #522 / #577 stop: completeness (QED) or a documented CCW
   ...
   not leftover `Ⅹ`. Leftover-Ⅶ classify does not take the
   left. Not a 522-j remint. *)
(* WITNESS {"claimId":"Ⅶ","topic":"relate","lemma":"triangle_pair_regime_ccw_stop","title":"Epic #522 stop is completeness (QED) or a documented CCW unsupported pair (QEX); discharged QEX on an unnamed swap nest","file":"theories/RelateNGTouchLens.v","witness":"Ⅶ-lens-cex","board":"leftover-Ⅶ"} *)
