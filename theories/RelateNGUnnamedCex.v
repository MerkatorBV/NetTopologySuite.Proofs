(* ============================================================================
   ...
   inhabitance (edge-cross residue) plus the unnamed inside
   completeness cex after leftover Ⅶ (not leftover `Ⅷ`).
   ...
   Live cex: A = (1,1)(2,1)(1,2) inside B = (0,0)(4,0)(0,4).
   ...
   Do not steal 522-j / 522-m. Do not mint leftover `Ⅷ`.
...
(* Parks on TPR_Lens. Not a lens denotation. Not leftover `Ⅷ`.               *)
(* -------------------------------------------------------------------------- *)
