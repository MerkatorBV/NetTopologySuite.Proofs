(* ============================================================================
   ...
   ----------------------------------------------------------------------------
   Leftover Ⅵ inhabitance (same-sign spill) plus the unnamed lens
   completeness cex after leftover Ⅵ (not leftover `Ⅶ`).
   ...
   Do not steal 522-j / 522-m. Do not mint leftover `Ⅶ`.
