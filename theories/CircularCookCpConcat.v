(* ============================================================================
   ...
   done (cathedral / Multi / optional Part 3 types). CS / CC / CP
   required-type statuses stay PhaseBRequiredGap and Phase B stays
   Open while mixed LS–CS is host Decline — same-kind endpoint
   joint Hits are the actual math; naming must not oversell Landed.
...
(* WITNESS: campaign=B rung=B.3 claim=0007
   ...
   park=Hperp,CircGamma-remint,bag-noder,SQL-MM-done,Phase-B-CS,Phase-B-CC,Phase-B-CP,Phase-B
   land=Phase-B.3-letter-only *)

(* B.1 / B.2 names, reused. Letter-local names; CS/CC/CP required-type
   statuses stay Gap (mixed LS–CS still host Decline). *)
