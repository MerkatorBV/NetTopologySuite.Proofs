(* ============================================================================
   ...
   stem. Ⅲ∨Ⅳ xor, two witnesses, fill token, completeness still Ⅱ.
   ...
   Completeness stays false (obtuse / Ⅱ). `classify_triangle_pair`
   arm is `True` — leftover Ⅰ honesty, not CONTEXT Bar 1. Nothing
   that mentions `TPR_TouchOnesided` may be proved through
   `classify_triangle_pair`. Do not steal 522-j / 522-m / 522-f /
   leftover Ⅰ. Do not invent leftover Ⅱ. Do not remint the xor.
   Do not mint 522-n / Ⅴ. Do not remint aa_matrix_*.
...
(* WITNESS {"claimId":"Ⅲ","topic":"relate","lemma":"triangle_pair_regime_onesided","title":"Ⅲ∨Ⅳ xor reaches TPR_TouchOnesided on the compiled leftover-Ⅲ exterior-side stem","file":"theories/RelateNGTouchOnesided.v","witness":"Ⅲ-onesided-t-xor","board":"leftover-Ⅲ"} *)
