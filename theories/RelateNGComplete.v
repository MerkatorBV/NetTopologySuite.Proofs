(* ============================================================================
   ...
   Completeness is still FALSE: an unnamed swap nest emits
   `TPR_Unsupported` after leftover `Ⅸ`.
   ...
   FALSE (unnamed swap nest after leftover `Ⅸ`). Not an ADR-0004 remint.
...
(* 522-m: leftover Ⅸ named the nest. Live cex is unnamed
...
(* WITNESS {"claimId":"522-j","topic":"relate","lemma":"triangle_pair_regime_ccw_incomplete","title":"Classifier completeness is still false after leftover Ⅸ: an unnamed swap nest emits TPR_Unsupported","file":"theories/RelateNGComplete.v","witness":"522-j-sentinel-cex","board":"#577"} *)
...
(* WITNESS {"claimId":"522-m","topic":"relate","lemma":"triangle_pair_regime_ccw_incomplete_not_tjunction","title":"Filtered CCW-completeness is still false: an unnamed swap nest declines after leftover Ⅸ names the nest","file":"theories/RelateNGComplete.v","witness":"522-m-complete-filtered","board":"#522"} *)
