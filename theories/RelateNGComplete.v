(* ============================================================================
   ...
   Leftover `Ⅵ` / `Ⅶ` classify same-cone / lens. Completeness
   is still FALSE on an unnamed inside pair.
   ...
   FALSE (unnamed inside pair after leftover `Ⅶ`). Not an ADR-0004 remint.
...
(* 522-m: leftover Ⅶ classified the lens. Live cex is unnamed
   A=(1,1)(2,1)(1,2) vs B=(0,0)(4,0)(0,4). Do not mint leftover `Ⅷ`. *)
...
(* WITNESS {"claimId":"522-j","topic":"relate","lemma":"triangle_pair_regime_ccw_incomplete","title":"Classifier completeness is still false after leftover Ⅶ: an unnamed inside pair emits TPR_Unsupported","file":"theories/RelateNGComplete.v","witness":"522-j-sentinel-cex","board":"#577"} *)
Theorem triangle_pair_regime_ccw_incomplete :
  exists ax ay bx by_ cx cy dx dy ex ey fx fy : R,
    ...
    triangle_pair_regime ax ay bx by_ cx cy dx dy ex ey fx fy
      = TPR_Unsupported.
Proof.
  exists 1, 1, 2, 1, 1, 2, 0, 0, 4, 0, 0, 4.
  split; [unfold gdbl; lra|].
  split; [unfold gdbl; lra|].
  exact unnamed_ccw_pair_unsupported.
Qed.

(* WITNESS {"claimId":"522-m","topic":"relate","lemma":"triangle_pair_regime_ccw_incomplete_not_tjunction","title":"Filtered CCW-completeness is still false: an unnamed inside pair declines after leftover Ⅶ classifies the lens","file":"theories/RelateNGComplete.v","witness":"522-m-complete-filtered","board":"#522"} *)
