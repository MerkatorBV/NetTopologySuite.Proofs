(* ============================================================================
   ...
   Completeness is still FALSE: an unnamed same-side shared-edge
   nest emits `TPR_Unsupported` after leftover `Ⅷ`.
   ...
   FALSE (unnamed same-side shared-edge nest after leftover `Ⅷ`). Not an ADR-0004 remint.
...
(* 522-m: leftover Ⅷ named the nest. Live cex is unnamed
...
(* WITNESS {"claimId":"522-j","topic":"relate","lemma":"triangle_pair_regime_ccw_incomplete","title":"Classifier completeness is still false after leftover Ⅷ: an unnamed same-side shared-edge nest emits TPR_Unsupported","file":"theories/RelateNGComplete.v","witness":"522-j-sentinel-cex","board":"#577"} *)
...
(* WITNESS {"claimId":"522-m","topic":"relate","lemma":"triangle_pair_regime_ccw_incomplete_not_tjunction","title":"Filtered CCW-completeness is still false: an unnamed same-side shared-edge nest declines after leftover Ⅷ names the nest","file":"theories/RelateNGComplete.v","witness":"522-m-complete-filtered","board":"#522"} *)
