(* ============================================================================
   ...
   Completeness is still FALSE: an unnamed inside pair emits
   `TPR_Unsupported` after leftover `Ⅶ`.
...
(* WITNESS {"claimId":"522-m","topic":"relate","lemma":"triangle_pair_regime_ccw_incomplete_not_tjunction","title":"Filtered CCW-completeness is still false: an unnamed inside pair declines after leftover Ⅶ names the residue","file":"theories/RelateNGComplete.v","witness":"522-m-complete-filtered","board":"#522"} *)
