(* ==========================================================================
   ...
   [H-bridge attack, C-3e step 3] The HANDOFF CONNECTOR: a single certified
   ...
   zero-hop equality; the convex-gap chord below is the general case.
...
From NTS.Proofs Require Import Distance Overlay OverlayGraph Vec Azimuth
                               ...
                               DartSideKit HandoffWedge CornerCorridorBridge.
